...
class GAN(tf.keras.Model):
    def __init__(self, d=None, g=None):
        ...
        self.g_bce_tracker = tf.keras.metrics.Mean(name='g_bce')
        self.g_mse_tracker = tf.keras.metrics.Mean(name='g_mse')
        self.g_gradvar_tracker = tf.keras.metrics.Mean(name='g_gradvar')
    ...
    def compile(self, d_opt, g_opt, loss_fn):
        ...
        self.g_gradvar_fn = GradientVariance()
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            g_loss = g_bce + g_mse*1e-2 + g_gradvar
        ...
        return {
            ...
            "g_bce": self.g_bce_tracker.result(),
            "g_mse": self.g_mse_tracker.result(),
            "g_gradvar": self.g_gradvar_tracker.result()
        }
